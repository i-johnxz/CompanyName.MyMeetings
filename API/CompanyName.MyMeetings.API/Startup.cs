...
namespace CompanyName.MyMeetings.API
{
    public class Startup
    {
        ...
        private const string MeetingsConnectionString = nameof(MeetingsConnectionString);
        ...
        private IServiceProvider CreateAutofacServiceProvider(IServiceCollection services)
        {
            ...
            AdministrationStartup.Initialize(this._configuration[MeetingsConnectionString], executionContextAccessor,
                _logger);
            ...
            PaymentsStartup.Initialize(this._configuration[MeetingsConnectionString],
                executionContextAccessor,
                _logger);
